...
if ($stmt = mysqli_prepare($conn, $query)) {
    ...
    elseif($result == $email)
    {
      ...
      $mesg = "Your Docunator password has been changed to $password \r\n"
	...
	throw new Exception('Error, invalid user email.'); 
		...
		if (mail($email, 'Docunator Login Information', $mesg, $from)){
	...
	<form id="form" name="form" action="email.php" method="post" enctype="multipart/form-data">
			...
			<p></p>
				...
				<label>Email Title:
					...
					<input type="text" name="email" value='Someone Shared this Docunator File: <?php $doc = strip_tags($_GET['doc']);?>'/>	
					<br />
					<br />
					<?php do_html_captcha(); ?>
				<br />
