...
$valid = $img->check($code); 
 ...
 $header = "Docunator | Hello, ".$user." you have posted!";
 $description = "Docunator | Successful Posting";
 $meta = "Docunator, Posting";
 $description = "This page contains the docunator comment posting page";
 
 do_html_upper($header, $description, $meta, $description);
